          ...
          <div className="wrapper flexitem">
            ...
            <div className="right">
              <ul className="flexitem main-links">
                ...
                <li>
                  <a href="#">USD
                    <span className="icon-small"><i className="ri-arrow-down-s-line"></i></span></a>
                  <ul>
                ...
                <div className="dpt-menu">
                  <ul className="second-links">
                    ...
                    <li className="has-child electronic">
                      <a href="#">
                        <div className="icon-large"><i className="ri-bluetooth-line"></i></div>
                        Electronic
                        <div className="icon-small"><i className="ri-arrow-right-s-line"></i></div>
                      </a>
                      <ul>
